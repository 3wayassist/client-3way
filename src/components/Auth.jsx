      ...
      <div className="flex items-center min-h-screen z-50">
        <div className="container mx-auto">
          <div className="max-w-md mx-auto my-10">
            ...
            <h1 className="my-3 text-4xl font-semibold text-white">
  3 WAY ASSIST
</h1>
              ...
              <form onSubmit={submitHandler}>
                ...
                <div className="relative mb-6">
                  ...
                  <input
                    ...
                    } rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-black-300 `}
                  />
                  {!isPassword && (
                ...
                <div className="mb-6">
                  <button
                    type="submit"
                    className="w-full px-3 py-3 font-semibold text-white bg-yellow-500 rounded-md focus:bg-black-600 focus:outline-none hover:bg-black hover:text-black-500 transition-all duration-300 hover:border-black-500 border-transparent border-2"
                  >
                    Sign in
                  </button>
                </div>
